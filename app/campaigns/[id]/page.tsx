        ...
        <div className="grid h-screen w-full pl-[56px]">
            ...
            <div className="flex flex-col">
                <header className="sticky top-0 z-10 flex h-[57px] items-center gap-1 border-b bg-background px-4">
                    <h1 className="text-xl font-semibold">Kampanya Detayı</h1>
                    <Drawer>
                ...
                <main className="flex-1 gap-4 overflow-auto p-4 flex">
                    ...
                    <div className="relative bg-muted/70 w-3/5">
                        <div className="p-10 h-full min-h-[50vh] overflow-hidden">
                            <CampaignPlaygroundBG />
                            <CampaignPlayground />
                        </div>
                    </div>
                    <div
                        className="w-1/5 relative hidden flex-col items-start gap-8 md:flex" x-chunk="dashboard-03-chunk-0"
                    >
...
export default CompaingsPageDetail